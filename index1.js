...
app.get('/', (req, res) => {
  ...
  res.send(`
    <!DOCTYPE html>
    <html><head><meta charset="utf-8"><title>App 1</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet"></head>
    <body class="bg-light">
      <nav class="navbar navbar-expand-lg navbar-dark bg-success mb-4">
        <div class="container">
          <a class="navbar-brand" href="/">Quản Lý Sinh Viên (App 1)</a>
          <div class="d-flex">
            ${isAuth
        ...
        ${isAuth
          ? `<div class="text-center">
               <div class="card shadow-sm mx-auto" style="max-width: 600px;">
                 <div class="card-body">
                   <h3>Chào mừng ${user.name} đến với App 1!</h3>
          ...
          : `<div class="text-center mt-5">
               <h1>Hệ Thống Quản Lý Sinh Viên (App 1)</h1>
...
app.get('/bangdiem', requiresAuth(), (req, res) => {
  const fakeScores = [
    { mon: "Toán Rời Rạc", diem: 8.5 },
    { mon: "Mạng Máy Tính", diem: 9.0 },
    { mon: "Lập trình Web", diem: 7.5 },
    { mon: "Cơ sở dữ liệu", diem: 8.0 },
    { mon: "An toàn thông tin", diem: 9.5 }
  ];
  ...
  res.send(`
    <!DOCTYPE html>
    <html><head><meta charset="utf-8"><title>Bảng điểm</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet"></head>
    <body class="bg-light">
